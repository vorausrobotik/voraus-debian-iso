...
release = importlib_metadata.version("voraus-debian-iso")
...
htmlhelp_basename = "voraus_debian_isodoc"
...
latex_documents = [
    (
        "index",
        "voraus_debian_iso.tex",
        "voraus Debian ISO Documentation",
